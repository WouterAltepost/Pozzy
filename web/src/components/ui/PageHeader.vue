...
<style scoped>
.page-header { display: flex; align-items: center; justify-content: space-between; gap: var(--sp-3) var(--sp-4); flex-wrap: wrap; margin-bottom: var(--sp-5); }
.title-row { display: flex; align-items: baseline; gap: var(--sp-3); min-width: 0; }
.meta { font-size: var(--fs-sm); color: var(--ink-3); font-variant-numeric: tabular-nums; }
