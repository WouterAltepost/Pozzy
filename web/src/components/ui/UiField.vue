...
.invalid .field-control :deep(input), .invalid .field-control :deep(select), .invalid .field-control :deep(textarea) { box-shadow: 0 0 0 2px color-mix(in srgb, var(--danger) 50%, transparent); }
</style>
