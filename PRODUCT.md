...
- Asset discrepancy found on 2026-09-15: favicon-svg.svg, pozzy.png and Group.png are red (#AF1616 in the SVG, #A81010 sampled from the PNGs) while pozzy-svg.svg carries fill #2E7338 (green). Treated as an export error; red is taken as the brand colour and pozzy-svg.svg is not used in the UI until the owner confirms. [inferred]
